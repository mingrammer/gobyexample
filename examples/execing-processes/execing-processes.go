// 직전의 예제에서 우리는 [외부 프로세스를 생성하는 법](spawning-processes)
...
func main() {
  ...
  //  만약 에러가 있다면 여기서 return value를 얻을 것입니다.
